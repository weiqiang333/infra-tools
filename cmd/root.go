...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.infra-tools.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".infra-tools" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".infra-tools")
	}
