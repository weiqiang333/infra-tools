...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.infra-files-server.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".infra-files-server" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".infra-files-server")
	}
